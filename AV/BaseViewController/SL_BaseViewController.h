...
@interface SL_BaseViewController : UIViewController<SL_UIViewControllerScrollBackgroundProtocol,SL_NavigationBarDelegate,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate>
