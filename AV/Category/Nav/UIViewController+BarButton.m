...
{
    UIView *view = [[UIView alloc] initWithFrame:CGRectMake(0, 0, NavButonH, NavButonH)];
    view.backgroundColor = kClearColor;
    UIButton *firstButton = [UIButton buttonWithType:UIButtonTypeCustom];
    firstButton.frame = CGRectMake(0, 0, NavButonH, NavButonH);
    ...
    [firstButton setImageEdgeInsets:UIEdgeInsetsMake(0, 5 * kSCREEN_WIDTH / 375.0, 0, 0)];
...
- (void)addRightBarButtonWithFirstImage:(UIImage *)firstImage action:(SEL)action
{
    ...
    [firstButton setImageEdgeInsets:UIEdgeInsetsMake(0, 0, 0, 5 * kSCREEN_WIDTH / 375.0)];
...
{
    UIButton *leftbBarButton = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, NavButonH, NavButonH)];
    [leftbBarButton setTitle:itemTitle forState:(UIControlStateNormal)];
    [leftbBarButton setTitleColor:color forState:(UIControlStateNormal)];
    leftbBarButton.titleLabel.font = font;
    ...
    [leftbBarButton setTitleEdgeInsets:UIEdgeInsetsMake(0, 5 * kSCREEN_WIDTH/375.0, 0, 0)];
...
- (void)addRightBarButtonItemWithTitle:(NSString *)itemTitle setFont:(UIFont *)font setTitleColor:(UIColor *)color action:(SEL)action
{
    ...
    UIButton *rightbBarButton = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, 88, NavButonH)];
    ...
    rightbBarButton.titleLabel.font = font;
    ...
    [rightbBarButton setTitleEdgeInsets:UIEdgeInsetsMake(0, 0, 0, 5 * kSCREEN_WIDTH/375.0)];
...
{
    UIView *view = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 80, NavButonH)];
    view.backgroundColor = kClearColor;
    
    UIButton *firstButton = [UIButton buttonWithType:UIButtonTypeCustom];
    firstButton.frame = CGRectMake(40, 0, 40, NavButonH);
    [firstButton setImage:firstImage forState:UIControlStateNormal];
    ...
    [firstButton setImageEdgeInsets:UIEdgeInsetsMake(0, 0, 0, - 8 * kSCREEN_WIDTH/375.0)];
    [view addSubview:firstButton];
    
    UIButton *secondButton = [UIButton buttonWithType:UIButtonTypeCustom];
    secondButton.frame = CGRectMake(0, 0, 40, NavButonH);
    ...
    [secondButton setImageEdgeInsets:UIEdgeInsetsMake(0, 0, 0, - 15 * kSCREEN_WIDTH/375.0)];
...
{
    UIView *view = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 120, NavButonH)];
    view.backgroundColor = kClearColor;
    
    UIButton *firstButton = [UIButton buttonWithType:UIButtonTypeCustom];
    firstButton.frame = CGRectMake(80, 0, 40, NavButonH);
    [firstButton setImage:firstImage forState:UIControlStateNormal];
    [firstButton addTarget:self action:firstAction forControlEvents:UIControlEventTouchUpInside];
    firstButton.contentHorizontalAlignment = UIControlContentHorizontalAlignmentCenter;
    [firstButton setImageEdgeInsets:UIEdgeInsetsMake(0, 0, 0, - 8 * kSCREEN_WIDTH/375.0)];
    ...
    UIButton *secondButton = [UIButton buttonWithType:UIButtonTypeCustom];
    secondButton.frame = CGRectMake(NavButonH, 0, 40, NavButonH);
    [secondButton setImage:secondImage forState:UIControlStateNormal];
    [secondButton addTarget:self action:secondAction forControlEvents:UIControlEventTouchUpInside];
    secondButton.contentHorizontalAlignment = UIControlContentHorizontalAlignmentCenter;
    [secondButton setImageEdgeInsets:UIEdgeInsetsMake(0, 0, 0, - 5 * kSCREEN_WIDTH/375.0)];
    [view addSubview:secondButton];
    ...
    [thirdButton setImageEdgeInsets:UIEdgeInsetsMake(0, 0, 0, - 5 * kSCREEN_WIDTH/375.0)];
...
- (void)addRightFourBarButtonsWithFirstImage:(UIImage *)firstImage firstAction:(SEL)firstAction secondImage:(UIImage *)secondImage secondAction:(SEL)secondAction thirdImage:(UIImage *)thirdImage thirdAction:(SEL)thirdAction fourthImage:(UIImage *)fourthImage fourthAction:(SEL)fourthAction{
    UIView *view = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 145, NavButonH)];
    view.backgroundColor = kClearColor;
    ...
    [firstButton addTarget:self action:firstAction forControlEvents:UIControlEventTouchUpInside];
    firstButton.contentHorizontalAlignment = UIControlContentHorizontalAlignmentCenter;
    [firstButton setImageEdgeInsets:UIEdgeInsetsMake(0, 8 * kSCREEN_WIDTH/375.0, 0, 0)];
    [view addSubview:firstButton];
    ...
    [secondButton addTarget:self action:secondAction forControlEvents:UIControlEventTouchUpInside];
    secondButton.contentHorizontalAlignment = UIControlContentHorizontalAlignmentCenter;
    [secondButton setImageEdgeInsets:UIEdgeInsetsMake(0, 8 * kSCREEN_WIDTH/375.0, 0, 0)];
    [view addSubview:secondButton];
    ...
    [thirdButton setImageEdgeInsets:UIEdgeInsetsMake(0, 8 * kSCREEN_WIDTH/375.0, 0, 0)];
    [thirdButton addTarget:self action:thirdAction forControlEvents:UIControlEventTouchUpInside];
    [view addSubview:thirdButton];
    ...
    [fourthButton setImageEdgeInsets:UIEdgeInsetsMake(0, 8 * kSCREEN_WIDTH/375.0, 0, 0)];
